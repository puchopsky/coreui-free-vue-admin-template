  ...
  <div class="animated fadeIn">
    <b-row>
      <b-col lg="3" sm="6">
        <b-card>
          ...
          <div>Lorem ipsum...</div>
          <b-progress :value="25" class="progress-xs my-3" height={} variant="success"/>
      ...
      <b-col lg="3" sm="6">
        <b-card>
          ...
          <div>Lorem ipsum...</div>
          <b-progress :value="25" class="progress-xs my-3" height={} variant="info"/>
          <small class="text-muted">Lorem ipsum dolor sit amet enim.</small>
        </b-card>
      </b-col>
      <b-col lg="3" sm="6">
        <b-card>
          ...
          <div>Lorem ipsum...</div>
          <b-progress :value="25" class="progress-xs my-3" height={} variant="warning"/>
          <small class="text-muted">Lorem ipsum dolor sit amet enim.</small>
        </b-card>
      </b-col>
      <b-col lg="3" sm="6">
        <b-card>
          ...
          <div>Lorem ipsum...</div>
          <b-progress :value="25" class="progress-xs my-3" height={} variant="danger"/>
          <small class="text-muted">Lorem ipsum dolor sit amet enim.</small>
        </b-card>
      </b-col>
    </b-row><!--/.row-->
    ...
    <b-row>
      ...
      <b-col cols="12" lg="3" sm="6">
        <b-card :no-body="true" footer-class="px-3 py-2">
          ...
          <div slot="footer">
            <b-link class="font-weight-bold font-xs btn-block text-muted" href="#">View More <i
              class="fa fa-angle-right float-right font-lg"></i></b-link>
          </div>
        </b-card>
      </b-col>
      <b-col cols="12" lg="3" sm="6">
    ...
    <b-card-group class="mb-4">
      <b-card>
        ...
        <b-progress :value="25" class="progress-xs mt-3 mb-0" height={} variant="info"/>
      </b-card>
      <b-card>
        <div class="h1 text-muted text-right mb-4">
        ...
        <b-progress :value="25" class="progress-xs mt-3 mb-0" height={} variant="success"/>
      </b-card>
      <b-card>
        <div class="h1 text-muted text-right mb-4">
        ...
        <b-progress :value="25" class="progress-xs mt-3 mb-0" height={} variant="warning"/>
      </b-card>
      <b-card>
        <div class="h1 text-muted text-right mb-4">
      ...
      <b-card>
        ...
        <b-progress :value="25" class="progress-xs mt-3 mb-0" height={} variant="danger"/>
      </b-card>
    </b-card-group>
    <b-row>
      <b-col md="2" sm="6">
