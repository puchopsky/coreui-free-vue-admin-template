<template>
  <div class="animated fadeIn">
    ...
    <b-card id="web-application" no-body>
    ...
    <b-card id="transportation" no-body>
    ...
    <b-card id="form-control" no-body>
    ...
    <b-card id="video-player" no-body>
    ...
    <b-card id="brand" no-body>
      ...
      <b-card-body>
        <div class="alert alert-warning">
          ...
          <a class="alert-link" href="https://adblockplus.org/en/bugs">report an issue with Adblock Plus</a> if you
          believe this to be
